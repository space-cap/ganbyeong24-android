...
- 필수 필드 검증:
  - 환자명, 보호자명: 2자 이상
  - 환자 상태, 간병 기간, 위치: 필수 선택/입력
  - 보호자 연락처: 필수 입력
  - 환자 연락처: 선택 사항 (입력 시 형식 검증)
...
- **의존성 주입**: Koin (ViewModel, Repository)
- **백엔드**: Firebase
...
data class CareRequest(
    ...
    val patientName: String = "",           // 환자명
    val guardianName: String = "",          // 보호자명
    ...
    val patientPhoneNumber: String? = null, // 환자 연락처 (선택)
    val guardianPhoneNumber: String = "",   // 보호자 연락처 (필수)
