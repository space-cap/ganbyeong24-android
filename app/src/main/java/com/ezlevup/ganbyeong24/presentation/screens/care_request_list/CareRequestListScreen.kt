            ...
            when {
                ...
                state.errorMessage != null -> {
                    Column(
                        ...
                        Button(onClick = { viewModel.loadCareRequests() }) { Text("다시 시도") }
                    }
                }
                state.careRequests.isEmpty() -> {
                    Column(
                        ...
                        Text(text = "신청 내역이 없습니다", style = MaterialTheme.typography.titleLarge)
                        Spacer(modifier = Modifier.height(8.dp))
                        Text(
...
fun CareRequestItem(careRequest: CareRequest) {
    Card(
        ...
        Column(modifier = Modifier.fillMaxWidth().padding(16.dp)) {
            ...
            InfoRow(label = "기간", value = "${careRequest.careStartDate} ~ ${careRequest.careEndDate}")
