 ...
 * 위치를 선택하는 드롭다운 컴포넌트
 *
 * 시/도와 구/군을 2단계로 선택할 수 있습니다.
 *
 * @param selectedCity 선택된 시/도
 * @param selectedDistrict 선택된 구/군
 * @param onCitySelected 시/도 선택 콜백
 * @param onDistrictSelected 구/군 선택 콜백
 * @param isError 에러 상태
            ...
            ExposedDropdownMenu(
                ...
                cities.forEach { city ->
                    DropdownMenuItem(
                            ...
                            onClick = {
                                onCitySelected(city)
                                onDistrictSelected("") // 시/도 변경 시 구/군 초기화
                                cityExpanded = false
                            }
                    )
                }
            ...
            ExposedDropdownMenuBox(
                ...
                ExposedDropdownMenu(
                    ...
                    districts[selectedCity]?.forEach { district ->
                        DropdownMenuItem(
                                text = { Text(district, fontSize = 18.sp) },
                                onClick = {
